...
public class Parent_form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parent_submit_btn=(Button)findViewById(R.id.parent_submit_btn);
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Parent_form.this);
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(getApplicationContext(), "Please Login First",
                    Toast.LENGTH_LONG).show();
            Intent intent = new Intent(Parent_form.this, Mainfile.class);
